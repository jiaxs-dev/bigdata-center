...
/**
 * 折线图维度与显示名称对应关系
 * @type {{order_nat_num: string, uv: string, order_sal_num: string, goods_book_num: string, pv: string, landing_pv: string, reg_um: string, new_uv: string, duration_avg: string, goods_course_num: string}}
 */
const DimensionName = {
  pv: "PV",
  uv: "UV",
  landing_pv: "落地页次数",
  duration_avg: "平均停留时长（单位：秒）",
  reg_um: "注册用户",
  order_nat_num: "订单静默",
  order_sal_num: "订单电销",
