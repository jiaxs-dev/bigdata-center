    ...
    <el-row>
      <el-col :span="24" style="padding-bottom:10px">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>方案分析</el-breadcrumb-item>
        </el-breadcrumb>
      </el-col>
    </el-row>
    <!-- 面包屑导航结束 -->
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        table: {
          ...
          SelectedDynamicTableColumns: ['exam_code'],
    ...
    methods: {
      ...
      tableResort(orderObj){
        let field = orderObj.prop,orderType= (orderObj.order === "descending"?"desc":"asc"),order = '{"field":"'+field+'","orderType":"'+orderType+'"}';
        this.getTableData(order);
      },
      /*请求api获取表格数据*/
      getTableData(order) {
